...
import { Heart, MessageCircle, Send, ThumbsUpIcon } from "lucide-react";
  ...
  return (
    <div className="">
        ...
        <div>
          {post?.comments && post.comments.length > 0 && (
            <p
              ...
              className="text-xs text-gray-500 cursor-pointer hover:underline mr-2 md:mr-0"
            >
      ...
      <div className="flex p-2 justify-between px-2 border-t">
        ...
        <Button variant="ghost" className="postButton hidden md:flex">
          <Heart className="mr-1 hidden md:flex" />
          Save
        </Button>
